...
//    public static final int WIDTH = 1920, HEIGHT = 1080, FPS = 60; //Desktop Native
    ...
    private static Chat chat; //This probably needs to go somewhere else when we work on the chat
     ...
     * We keep all the Sub-Entities organized in Masters and keep this as a global Playing-Static list with minimal maintenance.
     */
    ...
    public synchronized void start() {
         ...
         * TODO (Server Network Team): Move this out of Playing into a class in the network package and change it.
         */
...
---------HERE ENDS THE GAME LOOP!
    ...
    /**
     * Any entity added via this function will be passed to the Master Renderer and rendered in the Playing World.
    ...
    /**
     * Stops an entity from being passed to the Master Renderer and being rendered in the Playing World.
