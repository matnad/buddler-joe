 ...
 *
 * <p>Shine Damper: Softens reflection
 * Reflectivity: Intensifies reflectivity
 *
 * <p>Calculated in the shader as follows:
 ...
 * options like disableCulling
 * useFakeLighting: Simulate lighting when no normals are defined: Just sets the normal to vec3(0
 * .0, 1.0, 0.0).
 *
