...
public class Window {
   ...
   * Runs this: {@link GLFW#glfwPollEvents()}
   ...
   * This can be used to override the user's attempt to close the window, or to signal that it
   * should be closed.
   */
  public void stop() {
   ...
   * OpenGL ES.
   * If the swap interval is greater than zero, the GPU driver waits the specified number of
   * screen updates
  ...
  /**
   * Returns true if the Game Loop should update and render a frame. This is to limit the FPS of
   * the game.
   */
