 ...
 *
 * <p>This will change when we build a proper chat
...
class ChatText extends GuiText {
   ...
   */
  ChatText(String text, float fontSize, Vector3f colour, float alpha, FontType font,
           Vector2f position, float maxLineLength, boolean centered, boolean sent) {
