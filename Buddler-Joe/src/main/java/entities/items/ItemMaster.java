...
public class ItemMaster {
   ...
   *
   * <p>Generates an item of the chosen type and adds it to all relevant lists.
   ...
   * If an item is flagged as destroyed, remove that item from all relevant lists (and clean out
   * empty lists).
   */
