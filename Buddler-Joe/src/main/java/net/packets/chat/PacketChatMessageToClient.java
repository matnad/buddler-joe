...
/**
 *  *  Packet that gets send a chat message from the Server to the Client.
 *  *  Packet-Code: CHATC
 *  *  @author Moritz Würth
 */
public class PacketChatMessageToClient extends Packet {
     ...
     * Check if {@link PacketChatMessageToServer} is shorter then 130 characters.
     ...
     * If there are no errors the chat message get printed.
     */
