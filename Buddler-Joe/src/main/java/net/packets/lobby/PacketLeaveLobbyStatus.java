...
/**
 * Packet that gets send from the Server to the Client, to inform the him over the result of the lobby-leave attempt.
 * Packet-Code: LOBLS
...
public class PacketLeaveLobbyStatus extends Packet {
     ...
     * {@link PacketLeaveLobbyStatus#status} gets set to equal {@param data}.
     */
     ...
     * @param data A String that contains Information about the lobby-leave attempt.
     *             ("OK" or in the case of an error, a suitable errormessage)
     * {@link PacketLeaveLobbyStatus#status} gets set to equal {@param data}.
     */
     ...
     * Checks if {@link PacketLeaveLobbyStatus#status} is not null.
     * Checks that {@link PacketLeaveLobbyStatus#status} consists of extendet ASCII Characters.
     ...
     * If {@link PacketLeaveLobbyStatus#status} starts with "OK", the message "Successfully left lobby" gets printed.
