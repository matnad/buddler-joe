...
/**
 * Packet that gets send from the Server to the Client, to inform the him over the result of the lobby-join attempt.
 * Packet-Code: LOBJS
...
public class PacketJoinLobbyStatus extends Packet{
     ...
     * @param data A String that contains Information about the join attempt.
     ...
     * @param data A String that contains Information about the lobby-join attempt.
     *             ("OK" or in the case of an error, a suitable errormessage)
     * {@link PacketJoinLobbyStatus#status} gets set to equal data.
     */
     ...
     * Checks that {@link PacketJoinLobbyStatus#status} consists of extendet ASCII Characters.
     ...
     * If {@link PacketJoinLobbyStatus#status} starts with "OK", the message "Successfully joined lobby" gets printed.
