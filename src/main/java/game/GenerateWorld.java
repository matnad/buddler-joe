...
class GenerateWorld {
  ...
  //   *
  //   * @param loader Pass the main loader from the Game class. There is no reason to have more
  // than
  //   *     one loader.
  //   */
  ...
  //    float size = 3; // If this is not 3, you need to use the full block constructor and modify
  // the
