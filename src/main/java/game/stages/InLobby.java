...
public class InLobby {
  ...
  public static void init(Loader loader) {
    ...
    inLobby = new GuiTexture(loader.loadTexture("inLobbyTable"), new Vector2f(0, -0.040741f),
            new Vector2f(0.554167f, 0.757804f), 1);


    leave =
            new MenuButton(
                    loader, "leave_norm", "leave_hover", new Vector2f(-0.107511f, -0.9f),
                    new Vector2f(.097094f, .082347f));


    ready =
            new MenuButton(
                    loader, "ready_norm", "ready_hover", new Vector2f(0.107511f, -0.9f),
                    new Vector2f(.097094f, .082347f));
