...
public class Welcome {
  ...
  public static void init(Loader loader) {
    ...
    welcome = new GuiTexture(loader.loadTexture("welcome_placeholder"), new Vector2f(0, 0),
    ...
    change =
            new MenuButton(
                    loader, "change_placeholder", "change_placeholder",
                    new Vector2f(0.2f, -0.2f), new Vector2f(.105521f, .128333f));
    proceed =
            new MenuButton(
                    loader, "proceed_placeholder", "proceed_placeholder",
                    new Vector2f(0, -0.5f), new Vector2f(.105521f, .128333f));

    // Back
    back =
            new MenuButton(
                    loader, "back_placeholder", "back_placeholder",
                    new Vector2f(0.75f, -0.75f), new Vector2f(.105521f, .128333f));


  }

  /**
   * Game Loop while the stage is active. This runs
   * every frame as long as the Welcome-Menu is active.
