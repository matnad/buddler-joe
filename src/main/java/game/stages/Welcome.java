...
public class Welcome {
  ...
  public static void init(Loader loader) {
    ...
    welcome =
        new GuiTexture(
            loader.loadTexture("welcome_placeholder"),
            new Vector2f(0, 0),
    ...
    typeField =
        new GuiTexture(
            loader.loadTexture("buttonTest"),
            new Vector2f(-0.25f, -0.2f),
  ...
  /**
   * Game Loop while the stage is active. This runs every frame as long as the Welcome-Menu is
