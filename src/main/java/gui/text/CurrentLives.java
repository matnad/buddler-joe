...
/** Gui Object to display and update "Lives: (amount)". */
public class CurrentLives {
  ...
  /**
   * Create a text object to display the current lives of the active player. Must be updated every
  ...
  /**
   * Generate the text with prefix and lives amount to be displayed in the game.
   *
  ...
  /**
   * If necessary, update the amount of lives owned by the current player. Creates a new GuiString
