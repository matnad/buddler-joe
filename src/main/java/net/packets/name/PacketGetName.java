...
public class PacketGetName extends Packet {
  ...
  /**
   * Implementation of the abstract method validate to check the data Checks whether the String is
   * an Integer with the isInt method, then checks whether the player is on the Server or not an
   * adds Errors to the ErrorList if any occurs.
   */
  @Override
   ...
   * Creates a String which gets passed on to a PacketSendName class and then sent to client. The
   * String either contains OK and the username of the searched for player or an error message to be
