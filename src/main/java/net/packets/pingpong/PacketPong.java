...
/**
 * A pong packet can be created by instantiating this PacketPong class. Pong packets are created by
 * the <code>PingManager</code> class. This class inherits from the superclass <code>Packet</code>.
 * A <code>PacketPong</code> object contains the creation time of its respective <code>PacketPing
 * </code> object.
 *
...
public class PacketPong extends Packet {
  ...
  /**
   * Checks if the chars of <code>data</code> represent only digits. If one of the chars is a non
   * digit, the error will be saved.
   */
  @Override
  ...
  /**
   * Does the time calculation. It calculates the difference between the timestamp when the ping was
   * sent and the timestamp when the pong arrived to the respective sender.
   *
   * <p>If the clientId was not passed, the average ping of the respective client will be udated.
   * Otherwise, the average ping of the respective clientthread will be updated. If there is an
   * error in <code>data</code>, nothing will happen with the packet.
   *
